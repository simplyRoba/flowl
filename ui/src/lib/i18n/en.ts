const en = {
  ...
  plant: {
    ...
    replaceLogPhoto: "Replace photo",
    removeLogPhoto: "Remove photo",
    expandWateringGroup: "Expand watering entries",
    collapseWateringGroup: "Collapse watering entries",
  },
  care: {
    title: "Care Journal",
    filterAll: "All",
    ...
    wateredSince: "Watered {count} times, {from} – {to}",
    partialWateredSince: "Watered {count}+ times, {from} – {to}",
    partialWateringContinuation:
      "Older entries may continue this watering streak.",
    loadOlder: "Load older entries",
    loadingOlder: "Loading older entries…",
    retryOlder: "Retry loading older entries",
    refreshJournal: "Refresh journal",
    invalidOccurredAt: "Enter a valid occurrence time",
    futureOccurredAt: "Occurrence time cannot be in the future",
  },
  status: {
    overdue: "Overdue",
    due: "Due",
  ...
  form: {
    ...
    wateringDays: "Watering interval in days",
    none: "None",
  ...
  error: {
    ...
    updateCareEvent: "Failed to update care event",
    updateCareEventPhoto: "Care entry was saved, but the photo change failed",
