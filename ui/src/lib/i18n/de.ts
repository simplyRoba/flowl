...
export const de: Translations = {
  ...
  care: {
    ...
    wateredSince: "{count}\u00d7 gegossen, {from} – {to}",
    partialWateredSince: "{count}+\u00d7 gegossen, {from} – {to}",
    partialWateringContinuation:
      "Ältere Einträge könnten diese Gießserie fortsetzen.",
    loadOlder: "Ältere Einträge laden",
    loadingOlder: "Ältere Einträge werden geladen…",
    retryOlder: "Ältere Einträge erneut laden",
    refreshJournal: "Pflegetagebuch aktualisieren",
  ...
  settings: {
    ...
    aiDisabledHint: "FLOWL_AI_API_KEY setzen, um KI zu aktivieren.",
    provider: "Anbieter",
    model: "Modell",
    data: "Daten",
    backup: "Sicherung",
  ...
  form: {
    ...
    customShort: "Eigener:",
    days: "Tage",
    decreaseDays: "Tage verringern",
    increaseDays: "Tage erhöhen",
    wateringDays: "Gießintervall in Tagen",
    none: "Kein",
