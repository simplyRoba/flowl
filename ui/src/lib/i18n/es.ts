...
export const es: Translations = {
  ...
  care: {
    ...
    wateredSince: "Regada {count} veces, {from} – {to}",
    partialWateredSince: "Regada {count}+ veces, {from} – {to}",
    partialWateringContinuation:
      "Las entradas anteriores pueden continuar esta racha de riego.",
    loadOlder: "Cargar entradas anteriores",
    loadingOlder: "Cargando entradas anteriores…",
    retryOlder: "Reintentar cargar entradas anteriores",
    refreshJournal: "Actualizar diario",
  ...
  form: {
    ...
    days: "días",
    decreaseDays: "Disminuir días",
    increaseDays: "Aumentar días",
    wateringDays: "Intervalo de riego en días",
    none: "Ninguna",
