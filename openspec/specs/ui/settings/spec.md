...
Settings page with appearance, location management, MQTT status, AI assistant status, data stats, and about sections.
...
- **WHEN** the settings page loads
- **THEN** the MQTT section appears after "Locations" and before "AI Assistant"
